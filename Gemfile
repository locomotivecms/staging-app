...
gem 'locomotivecms', github: 'locomotivecms/engine', ref: '394d7927', branch: 'http_cache'
gem 'locomotivecms_steam', github: 'locomotivecms/steam', ref: '0715a9f', branch: 'http_cache', require: false
