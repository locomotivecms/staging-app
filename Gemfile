...
gem 'locomotivecms', github: 'locomotivecms/engine', ref: '8b13a538', branch: 'http_cache'
gem 'locomotivecms_steam', github: 'locomotivecms/steam', ref: '781585ba', branch: 'http_cache', require: false
